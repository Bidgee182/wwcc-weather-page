...
ALARM_DESCRIPTIONS = {
    # Grundfos Hydro MPC booster alarm/warning codes (doc 98393459, pp.43-45).
    # Same catalogue for system AlarmCode (204), WarningCode (205) and per-pump
    # AlarmCode (402/412/422/462). Unlisted codes still log as 'Code N'.
    1: "Leakage current",
    2: "Missing phase",
    ...
    15: "Modbus watchdog timeout (comms with main network lost)",
    16: "Other",
    25: "Setup conflict",
    28: "Battery low",
    ...
    68: "Media temperature too high in pipe",
    69: "Motor winding temperature high",
    70: "Thermal relay 2 in motor (for example thermistor)",
    72: "Hardware fault, type 1",
    73: "Hardware shutdown (HSD)",
    74: "Pump supply voltage high",
    75: "Internal voltage supply low",
    76: "Internal communication fault",
    77: "Communication fault, twin-head pump",
    80: "Hardware fault, IO 351 I/O module",
    83: "Verification error, EEPROM parameter area A",
    84: "Memory access error",
    85: "Verification error, BE parameter area (EEPROM)",
    87: "Multi sensor value exceeds limit (min/max)",
    88: "Sensor fault, general measuring sensor",
    89: "Signal fault, closed-loop feedback sensor",
    91: "Signal fault, temperature sensor 1",
    93: "Fall-back sensor signal fault",
    ...
    133: "Controlled I/O conflict",
    143: "Multi sensor sensor signal fault",
    ...
    159: "CIM module connection to product lost",
    ...
    165: "Signal fault, analog input",
    166: "Signal fault, analog input",
    167: "Signal fault, analog input",
    175: "Signal fault, temperature sensor 2",
    176: "Signal fault, temperature sensor 3",
    190: "Limit exceeded, supervised item 1",
    191: "Limit exceeded, supervised item 2",
    193: "Sensor limit 4 exceeded / Low level",
    203: "Alarm on all pumps",
    204: "Inconsistency between sensors",
    205: "Level/float switch sequence inconsistency",
    208: "Operation outside performance range",
    210: "Overpressure",
    211: "Underpressure",
    213: "VFD not ready",
    214: "Water shortage",
    215: "Soft pressure buildup time-out",
    ...
    249: "User defined event 1 triggered",
    250: "User defined event 2 triggered",
    253: "SMS data not received within time",
    254: "Water pipe system model data inconsistency",
}
